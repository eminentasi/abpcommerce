...
{
    public abstract class ABPCommerceWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ABPCommerceWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ABPCommerceWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ABPCommerceDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ABPCommerceDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ABPCommerceDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ABPCommerceDbContext, Task<T>> func)
        {
            T result;
