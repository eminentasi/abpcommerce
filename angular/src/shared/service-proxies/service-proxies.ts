...
export class CategoriesServiceProxy {
    ...
    get(id: number | undefined) : Observable<CategoryDto> {
        let url_ = this.baseUrl + "/api/services/app/Categories/Get?";
        if (id === null)
...
export class CategoryDto implements ICategoryDto {
    ...
    translations: CategoryTranslationDto[] | undefined;
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["translations"])) {
                ...
                for (let item of _data["translations"])
                    this.translations.push(CategoryTranslationDto.fromJS(item));
            }
        }
    }
...
export class CategoryTranslationDto implements ICategoryTranslationDto {
    ...
    static fromJS(data: any): CategoryTranslationDto {
        data = typeof data === 'object' ? data : {};
        let result = new CategoryTranslationDto();
        result.init(data);
        return result;
    }
